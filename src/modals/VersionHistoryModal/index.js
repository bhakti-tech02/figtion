      ...
      <div className="m-[auto] max-h-[97vh] overflow-y-auto">
          ...
          {apiData?.versions?.map((apiDataVersionsEle) => {
            ...
            <Input
              ...
              wrapClassName="3xl:ml-[21px] bg-gray_100 border border-gray_400 border-solid lg:ml-[14px] ml-[18px] mt-[4px] rounded-radius5 w-[53%] xl:ml-[16px]"
              name="Group24"
              placeholder= {moment(apiDataVersionsEle?.created_at).format("DD/MM/YYYY")}
            ...
            <Input
              ...
              wrapClassName="3xl:ml-[21px] 3xl:pl-[18px] 3xl:pr-[42px] 3xl:py-[14px] bg-gray_100 border border-gray_400 border-solid flex lg:ml-[14px] lg:pl-[11px] lg:pr-[27px] lg:py-[9px] ml-[18px] mt-[4px] pl-[15px] pr-[35px] py-[12px] rounded-radius5 w-[93%] xl:ml-[16px] xl:pl-[13px] xl:pr-[31px] xl:py-[10px]"
              name="Group24"
            ...
            <Column className="bg-gray_100 border border-gray_400 border-solid items-center lg:mb-[14px] xl:mb-[16px] mb-[18px] 3xl:mb-[21px] lg:ml-[14px] xl:ml-[16px] ml-[18px] 3xl:ml-[21px] mt-[4px] xl:p-[10px] p-[12px] 3xl:p-[14px] lg:p-[9px] rounded-radius5 w-[53%]">
              <Text className="font-normal lg:leading-[20px] xl:leading-[23px] leading-[26.00px] 2xl:leading-[26px] 3xl:leading-[31px] not-italic lg:text-[10px] xl:text-[12px] text-[14px] 3xl:text-[16px] text-gray_700 w-[98%]">
